...
Collaborators: tgd8275, ts4098

The .java file can be run on any OS having JDK 8.0 and above as follows:

STEP 1:
Compile the Java file using "javac Sudoku.java"

STEP 2:
Run the compiled Java classfile using "java Sudoku {arg1 arg2 arg3 ...}"
